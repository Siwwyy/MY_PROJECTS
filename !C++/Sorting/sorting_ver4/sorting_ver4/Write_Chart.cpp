...
void Write_Chart::Write_The_Chart()
{
	...
	{
		int drawing_chart = Console_Info.dwCursorPosition.Y + max_height;					//zmienna do rysowania wykresu w gore, zaczyna od dolu i idzie w gore
	...
	SetCursorPosition(0, Console_Info.dwCursorPosition.Y + max_height + 3);
}
